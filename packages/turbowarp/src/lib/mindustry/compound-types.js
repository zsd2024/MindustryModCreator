...
/**
 * Normalize a field with a compound type string into a structured field definition.
 * @param {object} field - The field definition to normalize
 * @returns {object} The normalized field definition
 */
const normalizeType = function (field) {
